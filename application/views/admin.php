...
<head>
    ...
    <link rel="stylesheet" href="https://coreui.io/demo/3.4.0/vendors/@coreui/chartjs/css/coreui-chartjs.css">
...
<body class="c-app">
    <div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
        <div class="c-sidebar-brand d-md-down-none">
            <svg class="c-sidebar-brand-full" width="118" height="46" alt="CoreUI Logo">
                <use xlink:href="https://coreui.io/demo/3.4.0/assets/brand/coreui-pro.svg#full"></use>
            </svg>
            <svg class="c-sidebar-brand-minimized" width="46" height="46" alt="CoreUI Logo">
                <use xlink:href="https://coreui.io/demo/3.4.0/assets/brand/coreui-pro.svg#signet"></use>
            </svg>
        </div>
        <ul class="c-sidebar-nav ps ps--active-y">
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="index.html">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-speedometer"></use>
            ...
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="colors.html">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-drop"></use>
                    </svg> Colors</a></li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="typography.html">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
                    </svg> Typography</a></li>
            <li class="c-sidebar-nav-title">Components</li>
            <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-puzzle"></use>
                    </svg> Base</a>
            ...
            <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-cursor"></use>
                    </svg> Buttons</a>
                <ul class="c-sidebar-nav-dropdown-items">
            ...
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="charts.html">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-chart-pie"></use>
                    </svg> Charts</a></li>
            <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-code"></use>
                    </svg> Editors</a>
                <ul class="c-sidebar-nav-dropdown-items">
                    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="editors/code-editor.html">
                            <svg class="c-sidebar-nav-icon">
                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-notes"></use>
            ...
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="google-maps.html">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-map"></use>
                    </svg> Google Maps<span class="badge badge-danger">PRO</span></a></li>
            <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-star"></use>
                    </svg> Icons</a>
                <ul class="c-sidebar-nav-dropdown-items">
            ...
            <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-bell"></use>
                    </svg> Notifications</a>
                <ul class="c-sidebar-nav-dropdown-items">
            ...
            <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-bolt"></use>
                    </svg> Plugins</a>
                <ul class="c-sidebar-nav-dropdown-items">
                    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="plugins/calendar.html">
                            <svg class="c-sidebar-nav-icon">
                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-calendar"></use>
                    ...
                    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="plugins/draggable-cards.html">
                            <svg class="c-sidebar-nav-icon">
                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-cursor-move"></use>
                    ...
                    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="plugins/spinners.html">
                            <svg class="c-sidebar-nav-icon">
                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-sync"></use>
                            </svg> Spinners<span class="badge badge-danger">PRO</span></a></li>
                </ul>
            </li>
            <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-columns"></use>
                    </svg> Tables</a>
                <ul class="c-sidebar-nav-dropdown-items">
            ...
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="widgets.html">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-calculator"></use>
            ...
            <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="login.html" target="_top">
                            <svg class="c-sidebar-nav-icon">
                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-account-logout"></use>
                            </svg> Login</a></li>
                    ...
                    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="404.html" target="_top">
                            <svg class="c-sidebar-nav-icon">
                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-bug"></use>
                            </svg> Error 404</a></li>
            ...
            <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-layers"></use>
                    </svg> Apps</a>
                <ul class="c-sidebar-nav-dropdown-items">
                    <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                            <svg class="c-sidebar-nav-icon">
                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-description"></use>
                            </svg> Invoicing</a>
                        <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
                            <svg class="c-sidebar-nav-icon">
                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-envelope-open"></use>
                            </svg> Email</a>
                        <ul class="c-sidebar-nav-dropdown-items">
            ...
            <li class="c-sidebar-nav-item c-d-compact-none c-d-minimized-none"><a class="c-sidebar-nav-label" href="#">
                    <svg class="c-sidebar-nav-icon text-danger">
                        <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-bookmark"></use>
            ...
            <div class="ps__rail-y" style="top: 0px; height: 683px; right: 0px;">
                <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 359px;"></div>
            </div>
        </ul>
        ...
        <header class="c-header c-header-light c-header-fixed">
            <button class="c-header-toggler c-class-toggler d-lg-none mfe-auto" type="button" data-target="#sidebar" data-class="c-sidebar-show">
                <svg class="c-icon c-icon-lg">
                    <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-menu"></use>
                </svg>
                ...
                <li class="c-header-nav-item px-3 c-d-legacy-none">
                    <button class="c-class-toggler c-header-nav-btn" type="button" id="header-tooltip" data-target="body" data-class="c-dark-theme" data-toggle="c-tooltip" data-placement="bottom" title="Toggle Light/Dark Mode">
                        <svg class="c-icon c-d-dark-none">
                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-moon"></use>
                        </svg>
                        <svg class="c-icon c-d-default-none">
                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-sun"></use>
                        </svg>
                    </button>
                </li>
            </ul>
            <ul class="c-header-nav">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg pt-0">
                        <div class="dropdown-header bg-light"><strong>You have 5 notifications</strong></div><a class="dropdown-item" href="#">
                            ...
                            <svg class="c-icon mfe-2 text-danger">
                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-user-unfollow"></use>
                            </svg> User deleted</a><a class="dropdown-item" href="#">
                            <svg class="c-icon mfe-2 text-info">
                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-chart"></use>
                            </svg> Sales report is ready</a><a class="dropdown-item" href="#">
                            <svg class="c-icon mfe-2 text-success">
                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-basket"></use>
                ...
                <li class="c-header-nav-item dropdown d-md-down-none mx-2"><a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                        <svg class="c-icon">
                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-list-rich"></use>
                ...
                <li class="c-header-nav-item dropdown d-md-down-none mx-2"><a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg pt-0">
                        <div class="dropdown-header bg-light"><strong>You have 4 messages</strong></div><a class="dropdown-item" href="#">
                            ...
                            <div class="message">
                                <div class="py-3 mfe-3 float-left">
                                    <div class="c-avatar"><img class="c-avatar-img" src="https://coreui.io/demo/3.4.0/assets/img/avatars/6.jpg" alt="user@email.com"><span class="c-avatar-status bg-warning"></span></div>
                                </div>
                            ...
                            <div class="message">
                                <div class="py-3 mfe-3 float-left">
                                    <div class="c-avatar"><img class="c-avatar-img" src="https://coreui.io/demo/3.4.0/assets/img/avatars/5.jpg" alt="user@email.com"><span class="c-avatar-status bg-danger"></span></div>
                                </div>
                            ...
                            <div class="message">
                                <div class="py-3 mfe-3 float-left">
                                    <div class="c-avatar"><img class="c-avatar-img" src="https://coreui.io/demo/3.4.0/assets/img/avatars/4.jpg" alt="user@email.com"><span class="c-avatar-status bg-info"></span></div>
                                </div>
                ...
                <li class="c-header-nav-item dropdown"><a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                        <div class="c-avatar"><img class="c-avatar-img" src="https://coreui.io/demo/3.4.0/assets/img/avatars/6.jpg" alt="user@email.com"></div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right pt-0">
                        <div class="dropdown-header bg-light py-2"><strong>Account</strong></div><a class="dropdown-item" href="#">
                            ...
                            <svg class="c-icon mfe-2">
                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-comment-square"></use>
                        ...
                        <div class="dropdown-header bg-light py-2"><strong>Settings</strong></div><a class="dropdown-item" href="#">
                            ...
                            <svg class="c-icon mfe-2">
                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-settings"></use>
                            </svg> Settings</a><a class="dropdown-item" href="#">
                            <svg class="c-icon mfe-2">
                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-credit-card"></use>
                            </svg> Payments<span class="badge badge-secondary mfs-auto">42</span></a><a class="dropdown-item" href="#">
                            <svg class="c-icon mfe-2">
                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-file"></use>
                            </svg> Projects<span class="badge badge-primary mfs-auto">42</span></a>
                        <div class="dropdown-divider"></div><a class="dropdown-item" href="#">
                            <svg class="c-icon mfe-2">
                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-lock-locked"></use>
            ...
            <div class="c-subheader justify-content-between px-3">
                ...
                <div class="c-subheader-nav d-md-down-none mfe-2"><a class="c-subheader-nav-link" href="#">
                        <svg class="c-icon">
                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-speech"></use>
                        </svg></a><a class="c-subheader-nav-link" href="#">
                        <svg class="c-icon">
                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-graph"></use>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="card text-white bg-gradient-primary">
                                    ...
                                    <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                                        ...
                                        <canvas class="chart chartjs-render-monitor" id="card-chart1" height="140" style="display: block; width: 338px; height: 70px;" width="676"></canvas>
                                        <div id="card-chart1-tooltip" class="c-chartjs-tooltip bottom top" style="opacity: 0; left: 207.537px; top: 139.396px;">
                                            <div class="c-tooltip-header">
                                                <div class="c-tooltip-header-item">July</div>
                                            </div>
                                            <div class="c-tooltip-body">
                                                <div class="c-tooltip-body-item"><span class="c-tooltip-body-item-color" style="background-color: rgb(50, 31, 219);"></span><span class="c-tooltip-body-item-label">My First dataset</span><span class="c-tooltip-body-item-value">40</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="card text-white bg-gradient-info">
                                    ...
                                    <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                                        ...
                                        <canvas class="chart chartjs-render-monitor" id="card-chart2" height="140" width="676" style="display: block; width: 338px; height: 70px;"></canvas>
                                        <div id="card-chart2-tooltip" class="c-chartjs-tooltip top bottom" style="opacity: 0; left: 84.9053px; top: 138.054px;">
                                            <div class="c-tooltip-header">
                                                <div class="c-tooltip-header-item">January</div>
                                            </div>
                                            <div class="c-tooltip-body">
                                                <div class="c-tooltip-body-item"><span class="c-tooltip-body-item-color" style="background-color: rgb(51, 153, 255);"></span><span class="c-tooltip-body-item-label">My First dataset</span><span class="c-tooltip-body-item-value">1</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="card text-white bg-gradient-warning">
                                    ...
                                    <div class="c-chart-wrapper mt-3" style="height:70px;">
                                        ...
                                        <canvas class="chart chartjs-render-monitor" id="card-chart3" height="140" width="740" style="display: block; width: 370px; height: 70px;"></canvas>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="card text-white bg-gradient-danger">
                                    ...
                                    <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                                        ...
                                        <canvas class="chart chartjs-render-monitor" id="card-chart4" height="140" width="676" style="display: block; width: 338px; height: 70px;"></canvas>
                                        <div id="card-chart4-tooltip" class="c-chartjs-tooltip top bottom" style="opacity: 0; left: 123.312px; top: 112.5px;">
                                            <div class="c-tooltip-header">
                                                <div class="c-tooltip-header-item">September</div>
                                            </div>
                                            <div class="c-tooltip-body">
                                                <div class="c-tooltip-body-item"><span class="c-tooltip-body-item-color" style="background-color: rgba(255, 255, 255, 0.2);"></span><span class="c-tooltip-body-item-label">My First dataset</span><span class="c-tooltip-body-item-value">65</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                                        ...
                                        <button class="btn btn-primary" type="button">
                                            <svg class="c-icon">
                                                <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-cloud-download"></use>
                                            </svg>
                                        </button>
                                    </div>
                                </div>
                                <div class="c-chart-wrapper" style="height:300px;margin-top:40px;">
                                    ...
                                    <canvas class="chart chartjs-render-monitor" id="main-chart" height="600" width="660" style="display: block; width: 330px; height: 300px;"></canvas>
                                    <div id="main-chart-tooltip" class="c-chartjs-tooltip center" style="opacity: 0; left: 406.66px; top: 190.144px;">
                                        <div class="c-tooltip-header">
                                ...
                                <div class="card">
                                    <div class="card-header bg-facebook content-center">
                                        <svg class="c-icon c-icon-3xl text-white my-4">
                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/brand.svg#cib-facebook-f"></use>
                                        </svg>
                                    </div>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="card">
                                    <div class="card-header bg-twitter content-center">
                                        <svg class="c-icon c-icon-3xl text-white my-4">
                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/brand.svg#cib-twitter"></use>
                                        </svg>
                                    </div>
                                    <div class="card-body row text-center">
                                        <div class="col">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="card">
                                    <div class="card-header bg-linkedin content-center">
                                        <svg class="c-icon c-icon-3xl text-white my-4">
                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/brand.svg#cib-linkedin"></use>
                                        </svg>
                                    </div>
                                    <div class="card-body row text-center">
                                        <div class="col">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="progress-group mb-5">
                                                    <div class="progress-group-header">
                                                        <svg class="c-icon progress-group-icon">
                                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/free.svg#cil-user-female"></use>
                                                        </svg>
                                                        <div>Female</div>
                                                ...
                                                <div class="progress-group">
                                                    <div class="progress-group-header align-items-end">
                                                        <svg class="c-icon progress-group-icon">
                                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/brand.svg#cib-google"></use>
                                                        </svg>
                                        ...
                                        <table class="table table-responsive-sm table-hover table-outline mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <svg class="c-icon c-icon-xl">
                                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/flag.svg#cif-us"></use>
                                                        </svg>
                                                    </td>
                                                    <td>
                                                        <div class="clearfix">
                                                    ...
                                                    <td class="text-center">
                                                        <svg class="c-icon c-icon-xl">
                                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/brand.svg#cib-cc-mastercard"></use>
                                                        </svg>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <svg class="c-icon c-icon-xl">
                                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/flag.svg#cif-br"></use>
                                                        </svg>
                                                    </td>
                                                    <td>
                                                        <div class="clearfix">
                                                    ...
                                                    <td class="text-center">
                                                        <svg class="c-icon c-icon-xl">
                                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/brand.svg#cib-cc-visa"></use>
                                                        </svg>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <svg class="c-icon c-icon-xl">
                                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/flag.svg#cif-in"></use>
                                                        </svg>
                                                    </td>
                                                    <td>
                                                        <div class="clearfix">
                                                    ...
                                                    <td class="text-center">
                                                        <svg class="c-icon c-icon-xl">
                                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/brand.svg#cib-cc-stripe"></use>
                                                        </svg>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <svg class="c-icon c-icon-xl">
                                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/flag.svg#cif-fr"></use>
                                                        </svg>
                                                    </td>
                                                    <td>
                                                        <div class="clearfix">
                                                    ...
                                                    <td class="text-center">
                                                        <svg class="c-icon c-icon-xl">
                                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/brand.svg#cib-cc-paypal"></use>
                                                        </svg>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <svg class="c-icon c-icon-xl">
                                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/flag.svg#cif-es"></use>
                                                        </svg>
                                                    </td>
                                                    <td>
                                                        <div class="clearfix">
                                                    ...
                                                    <td class="text-center">
                                                        <svg class="c-icon c-icon-xl">
                                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/brand.svg#cib-cc-apple-pay"></use>
                                                        </svg>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <svg class="c-icon c-icon-xl">
                                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/flag.svg#cif-pl"></use>
                                                        </svg>
                                                    </td>
                                                    <td>
                                                        <div class="clearfix">
                                                    ...
                                                    <td class="text-center">
                                                        <svg class="c-icon c-icon-xl">
                                                            <use xlink:href="https://coreui.io/demo/3.4.0/vendors/@coreui/icons/svg/brand.svg#cib-cc-amex"></use>
                                                        </svg>
                                                    </td>
                                                    <td>
    ...
    <script src="https://coreui.io/demo/3.4.0/vendors/@coreui/chartjs/js/coreui-chartjs.bundle.js"></script>
    <script src="https://coreui.io/demo/3.4.0/vendors/@coreui/utils/js/coreui-utils.js"></script>
    <script src="https://coreui.io/demo/3.4.0/js/main.js"></script>
    <script>
