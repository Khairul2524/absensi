...
<div class="page-body-wrapper horizontal-menu">
	...
	<header class="main-nav">
		<div class="sidebar-user text-center"><a class="setting-primary" href="javascript:void(0)"><i data-feather="settings"></i></a><img class="img-90 rounded-circle" src="<?= base_url('assets/backend/img/profile/') . $this->session->userdata('foto') ?>" alt="">
			<div class="badge-bottom"><span class="badge badge-primary">New</span></div><a href="user-profile.html">
				<h6 class="mt-3 f-14 f-w-600"><?= $this->session->userdata('namalengkap') ?></h6>
			</a>
			<p class="mb-0 font-roboto"><?= $this->session->userdata('nama_role') ?></p>
