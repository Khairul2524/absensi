								...
								<tbody>
									...
									?>
										<tr>
											...
											<td><?= $row->role ?></td>
											<td>
												<button class="btn-warning btn btn-sm btn-square tombol-ubah" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal" data-id="<?= $row->id_role ?>"> <i class="fa fa-edit"></i></button>
												<button class="btn btn-danger btn-sm tombol-h" href="<?= base_url('role/hapus/') . $row->id_role ?>"><i class="fa fa-trash"></i></button>
											</td>
										</tr>
									<?php } ?>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form class="needs-validation" action="<?= base_url('role/tambah') ?>" method="post">
...
<script>
	$(function() {
		...
		$('.tombol-tambah').on('click', function() {
			...
			$('#exampleModalLabel').html('Form Role')
